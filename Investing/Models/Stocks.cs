...
namespace Investing.Models
{
    ...
    //единая модель под все типы инструментов
    public class UnionModelInstruments
    {
        public UnionModelInstrumentSecurity Securities { get; set; }
        public UnionModelInstrumentMarketdata Marketdata { get; set; }
    }

    public interface IExpressionNumberMoex
    {
        string SECID { get; set; }
    }
    public class UnionModelInstrumentSecurity : IExpressionNumberMoex
    {
    ...
    public class SecurityStock : UnionModelInstrumentSecurity
    {
    ...
    public class MarketdataStock : UnionModelInstrumentMarketdata
    {
        public string? SECID { get; set; }
